...
def create_file_header(FileName, MyRandomDate):
    return """---
layout: post
title:  "%s"
date:   %s
...
# %s
""" % (FileName, MyRandomDate.strftime("%Y-%m-%d %H:%M:%S %z"), FileName, FileName, FileName)
...
for file in list_of_files:
    ...
    fnew.write(create_file_header(file.rpartition('.')[0], MyRandomDate))
